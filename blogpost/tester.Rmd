---
title: "'dockr': making Docker for R easy"
output:
...
image that mirrors your R session and includes all of the R dependencies 
...
4. Write Dockerfile and create all other files needed for the Docker image
